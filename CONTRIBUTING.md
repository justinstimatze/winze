...
- **Entity cap.** The KB targets depth over breadth. The default cap is `DefaultEntityCap` in schema.go (currently 300). Override with `WINZE_ENTITY_CAP` env var or `--entity-cap` flag. Deepen thin contested neighborhoods before expanding.
