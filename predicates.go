...
//
// ---- Taxonomy-tag UnaryClaim discipline (named pattern, session 4) ----
//
// Across sessions 1–4, a specific sub-shape of the unary style-claim
...
// in cognitive_biases.go's inline comment during session 3, and
// session 4 added the fifth occurrence without pushing back on
