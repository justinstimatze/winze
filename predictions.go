...
// Source: .metabolism-log.json (366 cycles, 42 hypotheses, 2026-04-12 to 2026-04-26)
//
...
var ConradApopheniaClinicalSearchOutcome = &ResolutionOutcome{
	Result:   "ambiguous",
	Evidence: "51 cycles, 24 with signal. Resolution: irrelevant — papers found but not relevant to the hypothesis. Sensor query may need refinement.",
}
...
// 2 cycles (2 with signal), aggregate: pending
// ---------------------------------------------------------------------------
...
var EvidenceSearchReificationRisk = Event{&Entity{
	...
	Kind:  "event",
	Brief: "Metabolism sensor query across arxiv, kagi for external sources on Reification Risk. Found: Measuring the Machine: Evaluating Generative AI as Pluralist Sociotechical Systems; The theory of “reification”; Lukács’s Theory of Reification and Contemporary Social Movements (+3 more).",
}}
