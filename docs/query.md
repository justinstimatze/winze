...
go run ./cmd/query --raw "gearbox rpm" .            # BM25 over the store's raw.jsonl evidence log — verbatim source text, not a typed claim (see docs/raw-evidence-retrieval.md)
