...
//      Authored docstring has anticipated: the
...
//     schema-forcing slice and the first institutional-
...
//        the primitive.
//
//     The deferred bridge is the second recent slice to surface
...
//     The pattern is becoming load-bearing: successive slices keep
...
//     zero claim-level bridges, zero fabrications — the
