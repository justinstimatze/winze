...
// Gödel incompleteness ingest: Wikipedia's article
...
//      No Theorem role type needed — same discipline as the
...
// reason ThoughtExperiment was rejected for the Chinese room: the structural
